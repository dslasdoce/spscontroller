...
namespace SmartHumpyController
{
    public class HumpyDAL
    {
        ...
        {
            DataSet zDataSet = null;
            Workers updateWorkersAppLog = new Workers();
            DataTable workersInOutStatus;
            ...
            string wifiIPAddress = getConfigValues.GetConfigValue(ConfigurationManager.ConnectionStrings["SmartHumpyController.Properties.Settings.Sys_DBConnectionLocal"].ToString(), getProgramValue.dbConfigProgramValue_WirelessIPAddress);
            ...
            try
            {
                ...
                string humpyLocationID = m_HumpyDetail.Sys_HumpyId;
                ...
                //workersInOutStatus = updateWorkersAppLog.WorkersInOutStatus(masterHumpyConnectionString);
                //if (workersInOutStatus.Rows.Count > 0)
                //{
                //    for (int loopCounter = 0; loopCounter <= workersInOutStatus.Rows.Count -1; loopCounter++)
                //    {
                //        if ((bool)workersInOutStatus.Rows[loopCounter]["CheckedIN"] == true)
                //        {
                ...
                //                                          (string)workersInOutStatus.Rows[loopCounter]["Name"],
                //                                          insertApplicationLogs.AppLogs_StatusCheckedValue,
                //                                          insertApplicationLogs.AppLogs_ActionOutValue,
                //                                          (string)workersInOutStatus.Rows[loopCounter]["TIDP"],
                //                                          humpyLocationID,
                //                                          wifiIPAddress);
                //        }
                //        else
        ...
        public bool SHS_Insert_Log(SHS_LogType AJt, string ADescription, string ACreatedBy,string HumpyID)
        {
           ...
           // Logs appLogs = new Logs();
            try
            {
                ...
                //appLogs.CreateApplicationLogs("LOGS", AJt.ToString(), ADescription, ACreatedBy, HumpyID, "", "", ConfigurationManager.ConnectionStrings["SmartHumpyController.Properties.Settings.Sys_DBConnectionLocal"].ToString());
        ...
        public bool SHS_Insert_History(SHS_JournalType AJt,string ADescription,string ACreatedBy)
        {
            ...
            try
            {
                ...
                //    zRet = true;
                //}
                appLogs.CreateApplicationLogs("HISTORY", AJt.ToString(), ADescription, ACreatedBy, "", "", "", ConfigurationManager.ConnectionStrings["SmartHumpyController.Properties.Settings.Sys_DBConnectionLocal"].ToString());
       ...
       /// <returns></returns>
        public bool SHS_Update_Personnel_CheckInOut(string aAccessCardUID, SHS_CheckInOutStatus aInOutStatus)
        {
            ...
            try
            {
                ...
                string zSqlStr = " UPDATE Personnel SET CheckedIn = " + zCheckInOut + " WHERE RTRIM(LTRIM(AccessCardUID)) = '" + aAccessCardUID.Trim() + "'";
                        ...
                        if (zDataSet.Tables.Count > 0)
                        {
                            if (zDataSet.Tables[0].Rows.Count > 0)
                            {
                                ...
                                if (zHD.HumpyGate.readerType == "R220")
                                    zHD.HumpyGate.GateReader.ReaderType = OctaneReader.ReaderType.R220;
                                else if (zHD.HumpyGate.readerType == "R420")
                                    zHD.HumpyGate.GateReader.ReaderType = OctaneReader.ReaderType.R420;
                                else if (zHD.HumpyGate.readerType == "XPortal")
                                    zHD.HumpyGate.GateReader.ReaderType = OctaneReader.ReaderType.XPortal;
                                ...
                                zHD.Sys_password = zDataSet.Tables[0].Rows[0]["Sys_password"].ToString();
                                zHD.Rd_UHFReader_IP  = zDataSet.Tables[0].Rows[0]["Rd_UHFReader_IP"].ToString();
