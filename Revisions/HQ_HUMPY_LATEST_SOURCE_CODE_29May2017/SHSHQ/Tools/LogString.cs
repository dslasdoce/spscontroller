...
namespace SHSHQ.Tools
{
    ...
    class LogString
    {
        ...
        private int m_nMaxChars = 320000;
        ...
        {
            m_strName = name;
            //OUT JL 16-OCT-2013 ReadLog();  // Read existing
        }
        ...
        private void WriteLog()
        {
            try
            {
                //IN JL 15-OCT-2013 START
                if (!File.Exists(FileName)) File.CreateText(FileName); // Not Exist Create New One
                ...
                lock (m_strLog)        // lock resource
                {
                    ...
                    m_strLog = "";//IN JL 15-OCT-2013
                }
                //IN JL 15-OCT-2013 END
            ...
            {
                ex.ToString();//06-FEB-2013 JL : To Solve possible file voliation issue.Ignore the exceptions.
            }
        }
        #endregion
        ...
        //IN JL 16-JAN-13 Start
        public void AddActions(string AStage, string str)
        {
            Add("Stage-" + AStage + " Action:" + str);
        }
        public void AddExceptions(string AStage, string str)
        {
            Add("Stage-" + AStage + " Exception:" + str);
        }
        public void AddErrors(string AStage, string str)
        {
            Add("Stage-" + AStage + " Error:" + str);
        }
        //IN JL 16-JAN-13 End

        // Add a log entry. Use the options to determine ordering, timestamping, etc.
        //
        public void Add(string AStrIn)
        {
            string zStrToAdd = "";
            if (m_bTimestamp)
            {
                // TBD: Allow user supplied timestamp formatting.
                //IN JL 27-SEP-2012 START
                StringBuilder zbuilder = new StringBuilder();//IN JL 27-SEP-2012 
                zbuilder.Append(zStrToAdd + DateTime.Now.ToString() + ": ");
                zStrToAdd = zbuilder.ToString();
                //IN JL 27-SEP-2012 END

                //OUT JL 27-SEP-2021 zStrToAdd += DateTime.Now.ToString() + ": ";
            }

            // Add the string
            //IN JL 27-SEP-2012 START
            StringBuilder zbuilder1 = new StringBuilder();//IN JL 27-SEP-2012 
            zbuilder1.Append(zStrToAdd + AStrIn);
            zStrToAdd = zbuilder1.ToString();
            //IN JL 27-SEP-2012 END

            //OUT JL 27-SEP-2012 zStrToAdd += AStrIn;

            // Add termination
            if (m_bLineTerminate)
            {
                //IN JL 27-SEP-2012 START
                StringBuilder zbuilder3 = new StringBuilder();//IN JL 27-SEP-2012 
                zbuilder3.Append(zStrToAdd + "\r\n");
                zStrToAdd = zbuilder3.ToString();
                //IN JL 27-SEP-2012 END

                //OUT JL 27-SEP-2012 zStrToAdd += "\r\n";
            }

            //OUT JL 15-OCT-2013 ReadLog();
            ...
            lock (m_strLog) // lock resource 
            {
                ...
                {
                    //IN JL 27-SEP-2012 START
                    //StringBuilder zMainLogBuilder = new StringBuilder(m_strLog);
                    //StringBuilder zbuilder = new StringBuilder();
                    //zbuilder.Append(zMainLogBuilder.ToString() + zStrToAdd);
                    //m_strLog = zbuilder.ToString();
                ...
                {
                    //IN JL 27-SEP-2012 START
                    StringBuilder zbuilder2 = new StringBuilder();//IN JL 27-SEP-2012 
                    StringBuilder zMainLogBuilder = new StringBuilder(m_strLog);
                    zbuilder2.Append(zStrToAdd + zMainLogBuilder.ToString());
                    m_strLog = zbuilder2.ToString();
                    //IN JL 27-SEP-2012 END

                    //OUT JL 27-SEP-2012 m_strLog = zStrToAdd + m_strLog;    // new entry on top
                }
                else
                {
                    //IN JL 27-SEP-2012 START
                    StringBuilder zMainLogBuilder = new StringBuilder(m_strLog);
                    StringBuilder zbuilder2 = new StringBuilder();
                    zbuilder2.Append(zMainLogBuilder.ToString() + zStrToAdd);
                    m_strLog = zbuilder2.ToString();
                    //IN JL 27-SEP-2012 END

                    //OUT JL 27-SEP-2012 m_strLog += zStrToAdd;              // new entry at the end
                }
            }
