...
namespace MISCReaderTCPIP
{
    ...
    {
        private string AntennaPortNum = "#";
        private string EPC = "#";
        public DateTime DateTimeStamp = DateTime.MinValue;
        private string TID = "#";
        private int PeakRSSI = 0;
        ...
        public string AntPort
        {
            get
            {
                return this.AntennaPortNum;
            }
            set
            {
                this.AntennaPortNum = value;
            }
        }
        ...
        //    get
        //    {
        //        return this.DateTimeStamp.ToString();
        //    }
        //    set
        //    {
        //        //this.DateTimeStamp =FromUnixTime(Convert.ToInt64(value));

        //        TimeZoneInfo est = TimeZoneInfo.FindSystemTimeZoneById("AUS Eastern Standard Time");
        //        DateTime targetTime = TimeZoneInfo.ConvertTime(FromUnixTime(Convert.ToInt64(value)), est);

        //        this.DateTimeStamp = targetTime;
        //    }
        //}
        ...
        {
            //Microseconds 1433122423 271 229
            //Milliseconds 1433122423 271


            //var epoch = new DateTime(1970, 1, 1, 0, 0, 0, DateTimeKind.Utc);
            //return epoch.AddSeconds(unixTime);

            long zMilliseconds = 0;
            if (unixTime.ToString().Length > 13)
            {
                zMilliseconds = Convert.ToInt64(unixTime.ToString().Substring(0, 13));
            }
                
            var epoch = new DateTime(1970, 1, 1, 0, 0, 0, DateTimeKind.Utc);
            return epoch.AddMilliseconds(zMilliseconds);
        }
    }
