...
namespace MISCReaderTCPIP
{
        ...
        public class StateObject
        {
            ...
            public SocketAsyncEventArgs e = new SocketAsyncEventArgs();
        ...
        public class AsynchronousClient
        {
            ...
            public IPEndPoint remoteEP = new IPEndPoint(IPAddress.Parse("172.16.0.1"), 8023);
            ...
            public void StartClient(object sender, System.ComponentModel.DoWorkEventArgs e)
            {
                ...
                try
                {
                   ...
                   // this.MyEventHandler = new EventHandler(ReceiveCallback);
                   // this.ReceiveCallback += this.MyEventHandler;
